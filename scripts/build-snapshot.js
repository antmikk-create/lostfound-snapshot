        ...
        >
          ...
          <div class="item-content">
            <div class="item-header">
              ...
              ${item.facebookLink ? `
                <a href="${escapeHtml(item.facebookLink)}" target="_blank" rel="noopener noreferrer" class="facebook-icon-link" title="Facebook-ilmoitus">
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .facebook-icon-link { display:inline-flex; align-items:center; margin-left:10px; color:#1877F2; opacity:0.8; transition:opacity 0.2s; }
